...
----
1.1.1b32Q (2026/04/11)
　- テストコード実行が動いてなかったのを修正
　- 見出しがないとEPUBチェックがエラーになるのを修正
　- newvelとdnovelsの削除と他
1.1.1b31Q (2025/10/28)
　- h1やdivのときにpタグを付与しないようにした
　- 画像にalt属性を追加
　- webp対応
　- Windowsインストーラー版の追加
1.1.1b30Q (2024/11/20)
　- 「SVG表紙生成」機能の追加
　- 表題のスタイルシートの追加
　- Ｗｅｂ小説抽出の変更
...
　- 表紙サイズ指定の修正
1.1.1b25Q (2024/08/25)
　- 使用しているライブラリの更新
　- IOUtils.copyをtransferToに書き換え
　- ページネーション読み込み機能の改修
1.1.1b24Q (2024/04/29)
　- Web小説のrbタグがないルビへの対応
　- 動作環境をJava 21 以降に限定
　- commons-compressの更新
1.1.1b23Q (2024/03/10)
　- リファクタリング
　- ユーザーエージェントを設定可能にした
